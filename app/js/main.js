...
//   });
// //------------------------------------------------------------------------------
//   $("#masterclassClickMenu").on('click', function () {
//
//   });
//   //------------------------------------------------------------------------------
//
//
// //------------------------------------------------------------------------------
//   $("#animatorClickMenu").on('click', function () {
//
//   });
// //------------------------------------------------------------------------------
//   $("#logInClickMenu").on('click', function () {
//
//     //$("#AdminContent").html( 'Введите данные пользователя' );
//   });
//------------------------------------------------------------------------------
  // $('#checkUserLogIn').on('click', clickCheckUserLogIn);
...
function loadFormAdminNewCard (programs) {
  ...
  '<form>' +
    ...
    '</div>' +
      ...
      '</div>' +
      '<button class="btn btn-primary col-6 offset-3" type="submit">Добавить</button>' +
    '</form>';
    return template;
}
...
function loadFormAdminMenu (number) {
  ...
  $.each(menu, function (i,item){
    ...
    template += '<a href="#" class="list-group-item list-group-item-action '+ active +'">'+ item +'</a>';
  });
  template +=
  '</div>';
  return template;
